# Cloudmersive.APIClient.NETCore.ImageRecognition - the C# library for the imageapi
...
```
nuget pack -Build -OutputDirectory out Cloudmersive.APIClient.NETCore.ImageRecognition.csproj
```
