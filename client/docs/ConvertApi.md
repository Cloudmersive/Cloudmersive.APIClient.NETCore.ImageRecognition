# Cloudmersive.APIClient.NETCore.ImageRecognition.Api.ConvertApi
...
namespace Example
{
    public class ConvertToGifExample
    {
        public void main()
        {
            // Configure API key authorization: Apikey
            ...
            {
                Debug.Print("Exception when calling ConvertApi.ConvertToGif: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ConvertToJpgDefaultQualityExample
    {
        public void main()
        {
            // Configure API key authorization: Apikey
            ...
            {
                // Convert input image to JPG, JPEG format
                Object result = apiInstance.ConvertToJpgDefaultQuality(imageFile);
                Debug.WriteLine(result);
            }
            catch (Exception e)
            {
                Debug.Print("Exception when calling ConvertApi.ConvertToJpgDefaultQuality: " + e.Message );
            }
        }
    }
}
...
namespace Example
{
    public class ConvertToPhotoshopExample
    {
        public void main()
        {
            // Configure API key authorization: Apikey
            ...
            {
                Debug.Print("Exception when calling ConvertApi.ConvertToPhotoshop: " + e.Message );
            }
        }
    }
}
