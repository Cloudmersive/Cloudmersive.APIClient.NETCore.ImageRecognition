...
namespace Cloudmersive.APIClient.NETCore.ImageRecognition.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FineTextDetectionResult :  IEquatable<FineTextDetectionResult>, IValidatableObject
    {
        /// <summary>
        ...
        public List<FineTextItem> TextItems { get; set; }
        ...
        {
            return this.Equals(input as FineTextDetectionResult);
        }

        /// <summary>
        /// Returns true if FineTextDetectionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of FineTextDetectionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FineTextDetectionResult input)
        {
            if (input == null)
                return false;
