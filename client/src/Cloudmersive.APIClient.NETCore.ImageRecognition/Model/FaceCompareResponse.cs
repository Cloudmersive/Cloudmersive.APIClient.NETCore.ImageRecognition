...
namespace Cloudmersive.APIClient.NETCore.ImageRecognition.Model
{
    ...
    public partial class FaceCompareResponse :  IEquatable<FaceCompareResponse>, IValidatableObject
    {
        ...
        public FaceCompareResponse(string ErrorDetails = default(string), bool? Successful = default(bool?), List<FaceMatch> Faces = default(List<FaceMatch>), int? FaceCount = default(int?))
        {
